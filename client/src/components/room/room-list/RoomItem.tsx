...
const RoomItem = () => {
  return (
    <div className="flex py-5 border-b border-gray-300 border-solid">
      <div>
        <img src="rooms/house.jpeg" alt="house" className="w-72 rounded-lg" />
      </div>
      <div className="ml-5 flex flex-col justify-center">
        <h6 className="text-gray-500">Entire guest suite in Burnaby</h6>
        ...
        <h6 className="text-gray-500 font-light">Wifi・1bedroom・1bed</h6>
